    ...
    <div v-if="locations && labels">
      <div class="flex flex-wrap md:flex-nowrap gap-4 items-end">
        ...
        <BaseButton class="btn-block md:w-auto" @click.prevent="submit">
          <template #icon>
            <Icon name="mdi:loading" v-if="loading" class="animate-spin" />
            <Icon name="mdi:magnify" v-else />
          </template>
          Search
        </BaseButton>
      </div>
        ...
        <div class="flex">
          <div class="btn-group">
            <button :disabled="!hasPrev" class="btn text-no-transform" @click="prev">
              <Icon name="mdi:chevron-left" class="mr-1 h-6 w-6" />
              Prev
            </button>
            ...
            <button :disabled="!hasNext" class="btn text-no-transform" @click="next">
              Next
              <Icon name="mdi:chevron-right" class="ml-1 h-6 w-6" />
            </button>
          </div>
        </div>
