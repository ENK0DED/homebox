      ...
      <div class="grid p-6 sm:place-items-center min-h-[50vh]">
        <div>
              ...
              <div class="card w-max-[500px] md:w-[500px] bg-base-100 shadow-xl">
                <div class="card-body">
                  <h2 class="card-title text-2xl align-center">
                    <Icon name="mdi:account" class="mr-1 w-7 h-7" />
                    Register
                  </h2>
          ...
          <div class="text-center mt-6">
            ...
            >
              <template #icon>
                <Icon name="mdi:account-plus" v-if="!registerForm" class="w-5 h-5 swap-off" />
                <Icon name="mdi:login" v-else class="w-5 h-5 swap-off" />
